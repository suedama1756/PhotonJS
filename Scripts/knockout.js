...
ko.extenders = {
    'throttle': function(target, timeout) {
        ...
        // (1) For dependent observable, we throttle *evaluations* so that, no matter how fast its dependencies
        //     notify updates, the target doesn't re-evaluate (and hence doesn't notify) faster than a certain rate
        target['throttleEvaluation'] = timeout;

        // (2) For writable targets (observable, or writable dependent observable), we throttle *writes*
